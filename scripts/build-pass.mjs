...
setField(pass.props.generic.primaryFields, "name", member.name);
setField(pass.props.generic.secondaryFields, "tier", member.tier);
setField(pass.props.generic.secondaryFields, "memberNo", member.memberNo);
